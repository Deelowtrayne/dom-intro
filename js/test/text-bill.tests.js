describe("Tests the Text Bill Widget", function(){
  ...
  it('Checks if the total alert function returns the (warning) flag', function(){
    var textBill = TextBill();
    ...
    textBill.total();
    assert.equal(textBill.totalAlert(), 'warning');
  });
});
